...
/*   Updated: 2024/11/13 17:34:13 by rlarbi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    printf("Recherche de \"%s\" dans \"%s\" avec len = %zu : %s\n",
           needle1, haystack1, len, ft_strnstr(haystack1, needle1, len));

    // Test 2: Rechercher un mot inexistant ("planet")
    len = 12;
    printf("Recherche de \"%s\" dans \"%s\" avec len = %zu : %s\n",
           needle2, haystack1, len, ft_strnstr(haystack1, needle2, len) ? "Trouvé" : "Non trouvé");
    ...
    len = 5;
    printf("Recherche de \"%s\" dans \"%s\" avec len = %zu : %s\n",
           needle1, haystack1, len, ft_strnstr(haystack1, needle1, len) ? "Trouvé" : "Non trouvé");
    ...
    len = 18;
    printf("Recherche de \"%s\" dans \"%s\" avec len = %zu : %s\n",
           needle4, haystack2, len, ft_strnstr(haystack2, needle4, len) ? "Trouvé" : "Non trouvé");
